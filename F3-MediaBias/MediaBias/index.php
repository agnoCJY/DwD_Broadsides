...
$f3->set('DB', $db); // 和 SimpleController.php 的 get('DB')对应
...
$f3->route('POST /simpleform',
  function($f3) {
	...
	$formdata["episode1"] = $f3->get('POST.episode1');		// whatever was called "colour" on the form
      $formdata["episode2"] = $f3->get('POST.episode2');		// whatever was called "colour" on the form
      $formdata["episode3"] = $f3->get('POST.episode3');		// whatever was called "colour" on the form

      $controller = new SimpleController; // 创建了一个new object
